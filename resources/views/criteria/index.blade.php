...
@section('content')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="title mb-30 text-end">
                    <a href="" class="main-btn btn-info btn-hover">Review Answers</a>
    ...
    {{-- ASSIGN TO ANSWER --}}
    @include('criteria.modals.assignToAnswer')
@endsection
    ...
    <script type="module">
        $(() => {
            ...
            tableInstance.on('draw.dt', function() {
                ...
                $('.assignToAnswerBtn').click(function() {
                    fetch('/criteria/' + $(this).data('criteria'))
                        .then(response => response.json())
                        .then(criteria => {
                            $('#criteria_id').val(criteria.id);
                        });
                });
