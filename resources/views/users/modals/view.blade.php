            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="duty_accomplished_registration_form" type="text" class="form-control" placeholder="{{ __('Duty Accomplished Registration Form') }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="list_of_officers_and_adviser" type="text" class="form-control" placeholder="{{ __('List of Officers and Adviser') }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="list_of_member_in_good_standing" type="text" class="form-control" placeholder="{{ __('List of Members in Good Standing') }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="constitution_and_by_laws" type="text" class="form-control" placeholder="{{ __('Constitution and By-Laws') }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="endorsement_certification" type="text" class="form-control" placeholder="{{ __('Endorsement Certification') }}" readonly>
